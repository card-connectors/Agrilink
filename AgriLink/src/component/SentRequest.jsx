...
const SentRequest = () => {
  const requests = [
    ...
    },
    {
      ...
      contact: "kavithafarms@gmail.com",
      ...
      <div className="mb-12 flex items-center justify-between">
        <div>
          <div className="flex items-center gap-3 mb-3">
            <h1 className="text-4xl font-bold text-gray-800">Sent Requests</h1>
          </div>
            ...
            <div className="p-6">
              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">To: {req.to}</p>
                  </div>
                </div>
                <span
              ...
              {req.status === "Pending" && (
                <div className="flex justify-end pt-4 border-t border-gray-100">
                  <button className="bg-red-100 hover:bg-red-200 text-red-700 px-4 py-2 rounded-xl font-medium transition-all duration-200 hover:shadow-md">
                    Cancel Request
                  </button>
                </div>
              )}
