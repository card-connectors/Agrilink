...
const Farmers = () => {
  ...
  const { setFarmerId } = useContext(EntityContext);
  ...
  useEffect(() => {
    ...
    fetch('http://127.0.0.1:8000/api/farmers/')
      .then((res) => res.json())
      .then((data) => {
        // If paginated response, data.results will have farmers
        const farmersData = data.results || data;
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-800 mb-4">Find Farmers for Your Land</h1>
          ...
          {filteredFarmers.map((farmer) => (
            ...
            >
              ...
              <div className="p-6 space-y-4">
                ...
                <div>
                  <p className="text-gray-600 text-sm leading-relaxed">{farmer.description}</p>
                </div>
              </div>
